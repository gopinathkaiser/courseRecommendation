...
const FindInterest = () => {
    ...
    const submit = async() => {
        try{
            let bdy ={
                'technical_interests': selectedOptions.tech,
                'interests': selectedOptions.general,
                'non_technical_interests': selectedOptions.nonTech,
                'achievements': selectedOptions.achievements
            }
            console.log(bdy);
            if(bdy.achievements === "" || bdy.interests==="" || bdy.technical_interests==="" || bdy.non_technical_interests === ""){
                alert("Fill all fields");
                return;
            }
            const resp = await httpClient.post('http://localhost:5000/pred/recommend',bdy)
