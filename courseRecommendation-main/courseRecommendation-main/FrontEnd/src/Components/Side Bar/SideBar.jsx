  ...
  return (
    <div className='w-[17rem] h-screen fixed py-[2rem] flex flex-col justify-between left-0 bg-[#DADADA]'>
        ...
        <div>
            ...
            <p className='pl-[2rem] mt-7 flex items-center cursor-pointer' onClick={()=>{localStorage.clear();navigate('/')}}><span className='text-2xl mr-3 opacity-70'><RiShutDownLine/></span>Log Out</p>
        </div>
