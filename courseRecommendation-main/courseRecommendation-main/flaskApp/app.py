...
def get_recommendation():
  ...
  "40": {
    ...
    "FutureDemand": "Varies - Depends on geopolitical situations and national defense needs"
        ...
        pred = rf_model.predict([[np.random.randint(41),np.random.randint(41),np.random.randint(41),np.random.randint(41)]])
        ...
        # Assuming outcome is a dictionary mapping choices to outcomes
